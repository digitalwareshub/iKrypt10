      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <Link to="/sign" className="text-gray-400 hover:text-indigo-400 transition-colors">
                  Digital Signature
                </Link>
              </li>
              <li>
                <Link to="/file-encrypt" className="text-gray-400 hover:text-indigo-400 transition-colors">
                  File Encryption
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-sm text-gray-400">
            &copy; 2025 iKrypt. All rights reserved.
          </p>
          <p className="text-sm text-gray-400 mt-4 md:mt-0">
            Secured with AES-256 encryption and zero-knowledge architecture
          </p>
        </div>
      </div>
    </footer>
