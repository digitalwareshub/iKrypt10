    ...
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 bg-gray-900/90 backdrop-blur-lg z-50 px-4 py-3 flex justify-between items-center">
        ...
        <button
          ...
          className="p-2 rounded-full bg-indigo-600/20 text-indigo-400 hover:bg-indigo-600/30 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          aria-label={expanded ? 'Close sidebar menu' : 'Open sidebar menu'}
      ...
      <aside
        id="sidebar-menu"
        className={`fixed top-0 h-full bg-gray-900/80 backdrop-blur-lg border-r border-indigo-500/20 z-40 transition-all duration-300 ${
      ...
      >
        <div className="h-full flex flex-col">
          {/* Logo */}
          <div
            className={`md:flex items-center justify-center py-6 ${
          ...
          <nav className="flex-1 overflow-y-auto py-4" aria-label="Main menu">
            <ul className="px-2 space-y-2" role="menubar">
              <li role="none">
                <button
                ...
                >
                  ...
                  {!expanded && (
                    <span
                      className="absolute left-full ml-2 p-2 bg-gray-800 rounded-md text-xs text-white opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap"
                      role="tooltip"
                    >
                      Home
                    </span>
              ...
              <li role="none">
                <button
                  ...
                  aria-label="Features"
                >
                  <FontAwesomeIcon icon={faShieldAlt} className="h-5 w-5" aria-hidden="true" />
              ...
              <li role="none">
                <button
                  ...
                  aria-label="Products"
                >
                  <FontAwesomeIcon icon={faCubes} className="h-5 w-5" aria-hidden="true" />
              ...
              <li role="none">
                ...
                >
                  <FontAwesomeIcon icon={faTools} className="h-5 w-5" aria-hidden="true" />
              ...
              <li role="none">
                ...
                >
                  <FontAwesomeIcon icon={faInfo} className="h-5 w-5" aria-hidden="true" />
              ...
              <li role="none">
                <button
                  ...
                  aria-label="FAQ"
                >
                  <FontAwesomeIcon icon={faQuestionCircle} className="h-5 w-5" aria-hidden="true" />
          ...
          {FEATURES.USER_AUTH_ENABLED && (
            <div className={`py-4 ${expanded ? 'px-4' : 'px-2'}`}>
              <Link
                ...
                aria-label="Login"
              >
                <FontAwesomeIcon icon={faSignInAlt} className="h-5 w-5" aria-hidden="true" />
          ...
          <button
            onClick={() => setExpanded(!expanded)}
            className="hidden md:flex items-center justify-center p-2 mx-auto mb-4 rounded-full bg-indigo-600/20 text-indigo-400 hover:bg-indigo-600/30 focus:outline-none focus:ring-2 focus:ring-indigo-500"
